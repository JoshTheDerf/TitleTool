...
import us.derfers.tribex.TriLib.DirectoryTools;
...
public class AppLoader {
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException {
		File swtJar = new File(getArchFilename(DirectoryTools.getJarDirectory()+"lib/SWT/swt"));
		System.out.println("[Debug] Loading SWT classes from: "+getArchFilename(DirectoryTools.getJarDirectory()+"lib/SWT/swt"));
